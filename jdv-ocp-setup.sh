...
oc create -f https://raw.githubusercontent.com/johnathonlee/jdv-ose-demo/master/extensions/datavirt-app-secret.yaml
...
curl https://raw.githubusercontent.com/johnathonlee/jdv-ose-demo/master/extensions/datasources.properties -o datasources.properties
...
oc new-app datavirt63-extensions-support-s2i -p SOURCE_REPOSITORY_URL=https://github.com/johnathonlee/jdv-ose-demo,CONTEXT_DIR=vdb,EXTENSIONS_REPOSITORY_URL=https://github.com/johnathonlee/jdv-ose-demo,EXTENSIONS_DIR=extensions,TEIID_USERNAME=teiidUser,TEIID_PASSWORD=redhat1!
echo '==============================================='
